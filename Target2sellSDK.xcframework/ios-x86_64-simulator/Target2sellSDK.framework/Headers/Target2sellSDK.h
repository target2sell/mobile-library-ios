...
@property (readonly) TSDKInt * _Nullable cartTotalAmount __attribute__((swift_name("cartTotalAmount")));
@property (readonly) TSDKInt * _Nullable categoryId __attribute__((swift_name("categoryId")));
